...
class DQNAgent(Agent):
	...
	def __init__(self, env, network, learning_rate, gamma, eps_max, eps_min, eps_dec, buffer_size, replace_cnt):
		...
		self.q_eval = LinearDQN(env.env_shape, env.no_of_actions)
		self.q_target = LinearDQN(env.env_shape, env.no_of_actions)
	...
	def update(self, batch_size):
		...
		curr_Q = self.q_eval.forward(states_t)[indices, actions]
